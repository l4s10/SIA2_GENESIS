    ...
    public function Grafico1(Request $request)
    {
        try {
            ...
            return response()->json([
                ...
                'message' => 'Reporte de ranking de gestionadores obtenido con exito desde la fecha ' . $fechaInicio->format('d-m-Y H:i:s') . ' hasta la fecha ' . $fechaFin->format('d-m-Y H:i:s') . '.'
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'status' => 'error',
    ...
    public function Grafico2(Request $request)
    {
        try {
            ...
            return response()->json([
                ...
                'message' => 'Reporte de solicitudes por entidad obtenido con exito desde la fecha ' . $fechaInicio->format('d-m-Y H:i:s') . ' hasta la fecha ' . $fechaFin->format('d-m-Y H:i:s') . '.'
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'status' => 'error',
    ...
    public function Grafico3(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => 'success',
                'data' => $rankingEstados,
                'message' => 'Reporte de ranking de estados obtenido con exito desde la fecha ' . $fechaInicio->format('d-m-Y H:i:s') . ' hasta la fecha ' . $fechaFin->format('d-m-Y H:i:s') . '.'
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'status' => 'error',
    ...
    public function Grafico4(Request $request)
    {
        try {
            ...
            return response()->json([
                ...
                'message' => 'Reporte de ranking de tipos de equipos obtenido con exito desde la fecha ' . $fechaInicio->format('d-m-Y H:i:s') . ' hasta la fecha ' . $fechaFin->format('d-m-Y H:i:s') . '.'
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'status' => 'error',
        ...
        try {
           ...
           // Promedio atencion desde revision a aprobado/rechazado
            ...
            return response()->json([
                ...
                'message' => 'Reporte de promedio de atención de solicitudes obtenido con exito desde la fecha ' . $fechaInicio->format('d-m-Y H:i:s') . ' hasta la fecha ' . $fechaFin->format('d-m-Y H:i:s') . '.'
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'status' => 'error',
