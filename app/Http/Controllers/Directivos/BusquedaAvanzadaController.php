...
class BusquedaAvanzadaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $delegados = Cargo::pluck('CARGO_NOMBRE', 'CARGO_ID');
        $firmantes = Cargo::pluck('CARGO_NOMBRE', 'CARGO_ID');
        ...
        return view('sia2.directivos.directivos.busquedaavanzada.index', compact('tipos', 'facultades', 'delegados', 'firmantes', 'fechas', 'nros', 'resoluciones'));
    }
