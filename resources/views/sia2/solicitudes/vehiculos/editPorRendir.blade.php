...
@section('title', 'Rendir Solicitud Vehicular')

@section('content_header')
    <h1>Rendición de Solicitud Vehicular</h1>
    <br>
    <br>
@stop
    ...
    <div  class="container">
        <form id="formulario" action="{{ route('solicitudesvehiculos.update', $solicitud->SOLICITUD_VEHICULO_ID) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    @if ($solicitud->SOLICITUD_VEHICULO_ESTADO == 'POR RENDIR')
                        <div class="mb-3">
                        ...
                        <!-- Leyenda -->
                        <div class="mb-3">
                            <small>La solicitud <strong>no</strong> ha sido firmada.</small>
                        </div>
                    @endif
                </div>
            ...
            <!-- Elementos de la solicitud se muestran u ocultan -->
            <div id="detalles" style="display: none;">
                        ...
                        <select name="VEHICULO_ID" id="VEHICULO_ID" class="form-control" disabled required>
                            ...
                            @foreach ($vehiculos as $vehiculo)
                                <option data-capacidad="{{ $vehiculo->tipoVehiculo->TIPO_VEHICULO_CAPACIDAD }}" value="{{ $vehiculo->VEHICULO_ID }}" {{ $solicitud->VEHICULO_ID == $vehiculo->VEHICULO_ID ? 'selected' : '' }}>
                                    Patente: {{ $vehiculo->VEHICULO_PATENTE }} - Marca: {{ $vehiculo->VEHICULO_MARCA }} - Tipo: {{ $vehiculo->tipoVehiculo->TIPO_VEHICULO_NOMBRE }} - Capacidad: {{ $vehiculo->tipoVehiculo->TIPO_VEHICULO_CAPACIDAD }}
                                </option>
                            @endforeach
                        </select>
                        @error('VEHICULO_ID')
                ...
                <div id="retornoDetalles" class="row mb-4">
                    <div class="col-md-3">
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="SOLICITUD_VEHICULO_REGION"class="form-control" value="{{ $solicitud->comunaDestino->region->REGION_NOMBRE }}" readonly>
                    </div>
            ...
            <div class="row mb-4">
                <div class="col-md-3">
                    <button id="botonDetalles" type="button" class="btn btn-custom" style="background-color: #1389EB; color: #fff;">
                        <i class="fa-solid fa-magnifying-glass-plus"></i> Mostrar Detalles
                    </button>
                </div>
            ...
            <br>         
            <br>
            <h3>Rendición de solicitud</h3>   
            <div style="height: 5px;"></div>

            <div class="row mb-4">
                <div class="col-md-6">
                    <label for="VEHICULO" class="form-label"><i class="fa-solid fa-car-side"></i> Vehículo asociado:</label>
                    <input id="VEHICULO" name="VEHICULO" type="text" class="form-control" style="text-align: center;"  value="{{'Patente: '.$solicitud->vehiculo->VEHICULO_PATENTE.' - Marca: '.$solicitud->vehiculo->VEHICULO_MARCA.' - Modelo: '.$solicitud->vehiculo->VEHICULO_MODELO.' - Tipo: '.$solicitud->vehiculo->tipoVehiculo->TIPO_VEHICULO_NOMBRE.' - Capacidad: '.$solicitud->vehiculo->tipoVehiculo->TIPO_VEHICULO_CAPACIDAD}}" readonly required>
                    @error('VEHICULO')
                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-3 ">
                    <label for="VEHICULO_NIVEL_ESTANQUE" class="form-label"><i class="fa-solid fa-gas-pump"></i> Nivel de Estanque:</label>
                        <input id="VEHICULO_NIVEL_ESTANQUE" name="VEHICULO_NIVEL_ESTANQUE" type="text" class="form-control" style="text-align: center;" value="{{ $solicitud->vehiculo->VEHICULO_NIVEL_ESTANQUE }}" readonly required>
            ...
            <div class="row mb-4">
                <div class="col-md-2">
                    <label for="RENDICION_NUMERO_BITACORA" class="form-label"><i class="fa-solid fa-arrow-up-9-1"></i> Bitácora:</label>
                    <input id="RENDICION_NUMERO_BITACORA" name="RENDICION_NUMERO_BITACORA" style="text-align: center;" placeholder="N° 24" type="number" min="1" max="999999"class="form-control" required>
                    @error('RENDICION_NUMERO_BITACORA')
                    <div class="error" style="color: #E22C2C">{{ $message }}</div>
                @enderror
                </div>
                <div class="col-md-2">
                    <label for="RENDICION_FECHA_HORA_LLEGADA" class="form-label"><i class="fa-solid fa-compass"></i> Fecha/hora llegada:</label>
                    <input id="RENDICION_FECHA_HORA_LLEGADA" name="RENDICION_FECHA_HORA_LLEGADA" style="text-align: center; background-color: #fff; color: #000;" type="datetime-local" class="form-control" required>
                    @error('RENDICION_FECHA_HORA_LLEGADA')
                    <div class="error" style="color: #E22C2C">{{ $message }}</div>
                @enderror
                </div>
                <div class="col-md-2">
                    <label for="RENDICION_TOTAL_HORAS" class="form-label"><i class="fa-solid fa-business-time"></i> Horas conducción:</label>
                    <input id="RENDICION_TOTAL_HORAS" name="RENDICION_TOTAL_HORAS" placeholder="Total horas" style="text-align: center;"  type="number" min="1" max="300" class="form-control" required>
                    @error('RENDICION_TOTAL_HORAS')
                    <div class="error" style="color: #E22C2C">{{ $message }}</div>
                @enderror
                </div>
                <div class="col-md-3">
                    <label for="RENDICION_KILOMETRAJE_INICIO" class="form-label"><i class="fa-solid fa-car"></i> Kilometraje vehículo al salir:</label>
                    <input id="RENDICION_KILOMETRAJE_INICIO" name="RENDICION_KILOMETRAJE_INICIO" style="text-align: center;" placeholder="KM al salir del estacionamiento" type="number" min="1" max="500000" class="form-control" required>
                    @error('RENDICION_KILOMETRAJE_INICIO')
                    <div class="error" style="color: #E22C2C">{{ $message }}</div>
                @enderror
                </div>
                
                <div class="col-md-3">
                    <label for="RENDICION_KILOMETRAJE_TERMINO" class="form-label"><i class="fa-solid fa-car"></i> Kilometraje vehículo al reingresar:</label>
                    <input id="RENDICION_KILOMETRAJE_TERMINO" name="RENDICION_KILOMETRAJE_TERMINO" style="text-align: center;" placeholder="KM al reingresar al estacionamiento" min="1" max="500000" type="number" class="form-control" required>
                    @error('RENDICION_KILOMETRAJE_TERMINO')
                    <div class="error" style="color: #E22C2C">{{ $message }}</div>
                @enderror
                </div>
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <label for="RENDICION_ABASTECIMIENTO" class="form-label"><i class="fa-solid fa-gas-pump"></i> ¿Abasteció bencina?</label>
                    <select id="RENDICION_ABASTECIMIENTO" name="RENDICION_ABASTECIMIENTO" class="form-control"  required>
                        <option style="text-align: center;" value="">-- Seleccione una opción --</option>
                        <option value="SI" {{ old('RENDICION_ABASTECIMIENTO') == 'SI' ? 'selected' : '' }}>SI</option>
                        <option value="NO" {{ old('RENDICION_ABASTECIMIENTO') == 'NO' ? 'selected' : '' }}>NO</option>
                    </select>
                    @error('RENDICION_ABASTECIMIENTO')
                    <div class="error" style="color: #E22C2C">{{ $message }}</div>
                @enderror
                    ...
                    <select id="RENDICION_NIVEL_ESTANQUE" name="RENDICION_NIVEL_ESTANQUE" class="form-control"  required>
                        ...
                        <option value="MEDIO LLENO" {{ old('RENDICION_NIVEL_ESTANQUE') == 'MEDIO LLENO' ? 'selected' : '' }}>MEDIO LLENO</option>
                        <option value="LLENO" {{ old('RENDICION_NIVEL_ESTANQUE') == 'LLENO' ? 'selected' : '' }}>LLENO</option>
                    </select>
                    @error('RENDICION_NIVEL_ESTANQUE')
                    <div class="error" style="color: #E22C2C">{{ $message }}</div>
                @enderror
                </div>
                ...
                <div class="col-md-6">
                    <label for="RENDICION_OBSERVACIONES" class="form-label"><i class="fa-solid fa-pen-to-square"></i> Observaciones:</label>
                    <textarea id="RENDICION_OBSERVACIONES" name="RENDICION_OBSERVACIONES" placeholder="Ingrse sus observaciones (MAX 255 caracteres)." class="form-control" style="height: 123px;"></textarea>
                    @error('RENDICION_OBSERVACIONES')
                    <div class="error" style="color: #E22C2C">{{ $message }}</div>
                @enderror
                </div>
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="botonRendir">
                            <button type="button" class="btn btn-custom" onclick="validarFormulario()" id="botonRendicion" style="background-color: #00B050; color: white;" name="botonRendicion" ><i class="fa-solid fa-clipboard-check" style="margin-right: 5px;"></i> Rendir Solicitud</button>
                        </div>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <script>
            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    if (response.message === 'Contraseña correcta') {
                        // Contraseña correcta, enviar el formulario
        ...
        // Función para validar los datos del formulario antes de abrir el modal de contraseña
        function validarFormulario() {
            ...
            if (rendicionCompleta) {
                ...
                // Supongamos que aquí realizas la validación y decides abrir el modal si todo está bien
                abrirModal();
            } else {
    ...
    <script>
        ...
        // Obtener el botón y los detalles
        const botonDetalles = document.getElementById('botonDetalles');
        const detalles = document.getElementById('detalles');
        const retornoDetalles = document.getElementById('retornoDetalles');
        ...
        botonDetalles.addEventListener('click', function() {
            ...
            if (detalles.style.display === 'none') {
                ...
                botonDetalles.innerHTML = '<i class="fa-solid fa-magnifying-glass-minus"></i> Ocultar Detalles';
                // Desplazar la página hasta la sección de Solicitante
                window.scrollTo({
                    top: retornoDetalles.offsetTop,
                    behavior: "smooth" // Desplazamiento suave
                });
            } else {
                // Si están visibles, ocultarlos
                detalles.style.display = 'none';
                botonDetalles.innerHTML = '<i class="fa-solid fa-magnifying-glass-plus"></i> Mostrar Detalles';
                // Desplazar la página hasta la sección de Solicitante
                window.scrollTo({
...
{{--
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            let inputfechaHoraRendicion = document.getElementById('RENDICION_FECHA_HORA_LLEGADA');
            let inputKilometrajeInicio = document.getElementById('RENDICION_KILOMETRAJE_INICIO');
            ...
            if (inputfechaHoraRendicion.value.trim() === '') {
                inputfechaHoraRendicion.setAttribute('placeholder', '-- Seleccione una fecha y hora --');
            }
    
            inputKilometrajeInicio.addEventListener('change', function() {
                let kilometrajeInicio = parseInt(inputKilometrajeInicio.value);
                let kilometrajeTermino = parseInt(inputKilometrajeTermino.value);
    
    
                console.log("km inicio: ", kilometrajeInicio);
                console.log("km término: ", kilometrajeTermino);
    
                if (kilometrajeInicio <= 0 || kilometrajeInicio > 999999) {
                    alert('El kilometraje de inicio debe ser mayor que 1 y menor o igual a 999999.');
                    inputKilometrajeInicio.value = ''; // Limpiar el campo
                } else if (kilometrajeTermino !== '' && kilometrajeInicio >= kilometrajeTermino) {
                    alert('El kilometraje de inicio debe ser menor que el kilometraje de término.');
                    inputKilometrajeInicio.value = ''; // Limpiar el campo
                } 
            });
    
            inputKilometrajeTermino.addEventListener('change', function() {
                let kilometrajeInicio = parseInt(inputKilometrajeInicio.value);
                let kilometrajeTermino = parseInt(inputKilometrajeTermino.value);
                ...
                if (kilometrajeTermino <= 0 || kilometrajeTermino > 999999) {
                    alert('El kilometraje de término debe ser mayor que 1 y menor o igual a 999999.');
                    inputKilometrajeTermino.value = ''; // Limpiar el campo
                } else if (kilometrajeInicio !== '' && kilometrajeInicio >= kilometrajeTermino) {
                    alert('El kilometraje de término debe ser mayor que el kilometraje de inicio.');
                    inputKilometrajeTermino.value = ''; // Limpiar el campo
                } else if (isNaN(kilometrajeInicio)) {
                    alert('Ingrese un valor para el kilometraje de inicio');
                    inputKilometrajeInicio.value = ''; // Limpiar el campo
                }
            });
    
            inputTotalHoras.addEventListener('change', function() {
                if (inputTotalHoras.value <= 0 || inputTotalHoras.value > 300) {
                    alert('Ingrese una cantidad válida de horas de conducción. ');
                    inputTotalHoras.value = ''; // Limpiar el campo
                } 
            });
    
            inputNumeroBitacora.addEventListener('change', function() {
                if (inputNumeroBitacora.value <= 0 || inputNumeroBitacora.value > 999999) {
                    alert('Ingrese un número de bitácora válido. ');
                    inputNumeroBitacora.value = ''; // Limpiar el campo
                } 
            });
        });
    </script>
