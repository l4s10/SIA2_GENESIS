                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center">
                                ...
                                <a href="{{ route('solicitudes.salas.edit', $solicitud->SOLICITUD_ID) }}" class="btn btn-secondary ml-2"><i class="fa-solid fa-pencil"></i></a>
                                <form action="{{ route('solicitudes.salas.destroy', $solicitud->SOLICITUD_ID) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
