...
@section('content_header')
    ...
    <div class="alert alert-info alert1" role="alert">
        <div>Bienvenido al módulo de <strong>solicitar sala</strong>. En el presente módulo usted podrá solicitar distintas salas, según sea el caso el Departamento de Administración analizará la disponibilidad de auxiliares y coordinará según sea el caso.</div>
    </div>
    @else
