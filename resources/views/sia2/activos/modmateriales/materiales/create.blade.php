...
<div class="container">
    <form action="{{ route('materiales.store') }}" method="POST">
        ...
        {{-- NUMERO FACTURA Y CODIGO LIBRO ADQUISICIONES --}}
        <div class="row">
            {{-- NUMERO FACTURA --}}
            <div class="col-md-6 mb-3">
        ...
        {{-- NUMERO RESOLUCION EXCENTO COMPRA Y NUMERO ORDEN COMPRA --}}
        <div class="row">
            {{-- NUMERO RESOLUCION EXCENTO COMPRA --}}
            <div class="col-md-6 mb-3">
        ...
        {{-- DIRECCION REGIONAL ASOCIADA (SOLO VISUAL) --}}
        <div class="mb-3">
