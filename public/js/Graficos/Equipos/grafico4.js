document.addEventListener('DOMContentLoaded', function() {
    ...
    const chart4 = new Chart(ctx4, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Ranking de equipos más solicitados',
    ...
    function updateChart(data) {
        if (Array.isArray(data.data)) {
            chart4.data.labels = data.data.map(item => item.TIPO_EQUIPO_NOMBRE);
    ...
    async function fetchDataAndUpdateChart() {
        try {
            ...
            await fetch('/api/reportes/equipos/grafico-4', {
                method: 'POST',
                headers: {
