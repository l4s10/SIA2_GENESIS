document.addEventListener('DOMContentLoaded', function() {
    ...
    const myChart2 = new Chart(ctx2, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Solicitudes de equipos requeridos por Ubicación/Departamento',
    ...
    async function fetchDataAndUpdateChart() {
        try {
            ...
            await fetch('/api/reportes/equipos/grafico-2', {
                method: 'POST',
                headers: {
    ...
    // Llama a la función para que se ejecute al cargar la página (CARGA FILTRADA)
    document.querySelector('#refresh-button').addEventListener('click', function() {
        ...
        fetch('/api/reportes/equipos/grafico-2', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
