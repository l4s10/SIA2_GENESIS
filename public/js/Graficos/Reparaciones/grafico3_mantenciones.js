document.addEventListener('DOMContentLoaded', function() {
    const ctx2 = document.getElementById('graficoSolicitudesMantencionesPorDepartamento').getContext('2d');
    const myChart2 = new Chart(ctx2, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Solicitudes de reparaciones de inmuebles requeridos por Ubicacion/Departamento',
    ...
    async function fetchDataAndUpdateChart() {
        try {
            ...
            await fetch('/api/reportes/reparaciones/grafico-6', {
                method: 'POST',
                headers: {
    ...
    document.querySelector('#refresh-button').addEventListener('click', function() {
        ...
        fetch('/api/reportes/reparaciones/grafico-6', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
